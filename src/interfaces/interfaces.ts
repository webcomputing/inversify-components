...
export interface ComponentBinder {
  ...
  bindExecutable(
    componentInterface: symbol,
    extensionClass: { new (...args: any[]): ExecutableExtension }
  ): inversifyInterfaces.BindingWhenOnSyntax<ExecutableExtension>;
}
...
export interface MainApplication<ExecuteReturn = void> {
  execute(container: Container): ExecuteReturn;
}
...
export interface Container {
  ...
  runMain(): ReturnType<MainApplication["execute"]>;
}
